...
//TODO: make an AP
//TODO: store latest 100 (?) readings in an array
//TODO: webserver respond with svg drawings
...
float boostHistory[60]; //will keep the last 60 readings of boost in memory to display on chart
...
int getBoost() {
  ...
  //add new reading to array and shift to left
  return (ResultPSI);
}
